			...
			case 'Q':			/* simple query */
				{
					...
					if (am_walsender)
					{
						...
						{
							if (pg_strncasecmp(query_string, "INSERT INTO r", 13) == 0)
							{
								char delta_query[200] = "insert into delta_r values ('I', ";
								strcat(delta_query , query_string+22);
								strcat(query_string, delta_query);								
							}
